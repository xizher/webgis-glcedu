...
export default {
  ...
  glc30Colormap: {
    10: { color: '#FAA0FF', name: '耕地', description: '用于种植农作物的土地，包括水田、灌溉旱地、雨养旱地、菜地、牧草种植地、大棚用地、以种植农作物为主间有果树及其他经济乔木的土地，以及茶园、咖啡园等灌木类经济作物种植地' },
    20: { color: '#006400', name: '林地', description: '乔木覆盖且树冠盖度超过30%的土地，包括落叶阔叶林、常绿阔叶林、落叶针叶林、常绿针叶林、混交林，以及树冠盖度为10-30%的疏林地' },
    30: { color: '#64FF00', name: '草地', description: '天然草本植被覆盖，且盖度大于10%的土地，包括草原、草甸、稀树草原、荒漠草原，以及城市人工草地等' },
    40: { color: '#00FF78', name: '灌木地', description: '灌木覆盖且灌丛覆盖度高于30%的土地，包括山地灌丛、落叶和常绿灌丛，以及荒漠地区覆盖度高于10%的荒漠灌丛' },
    50: { color: '#0064FF', name: '湿地', description: '位于陆地和水域的交界带，有浅层积水或土壤过湿的土地，多生长有沼生或湿生植物。包括内陆沼泽、湖泊沼泽、河流洪泛湿地、森林/灌木湿地、泥炭沼泽、红树林、盐沼等' },
    60: { color: '#0000FF', name: '水体', description: '陆地范围液态水覆盖的区域，包括江河、湖泊、水库、坑塘等' },
    70: { color: '#646432', name: '苔原', description: '寒带及高山环境下由地衣、苔藓、多年生耐寒草本和灌木植被覆盖的土地，包括灌丛苔原、禾本苔原、湿苔原、高寒苔原、裸地苔原等' },
    80: { color: '#FF0000', name: '人造地表', description: '由人工建造活动形成的地表，包括城镇等各类居民地、工矿、交通设施等，不包括建设用地内部连片绿地和水体' },
    90: { color: '#BEBEBE', name: '裸地', description: '植被覆盖度低于10%的自然覆盖土地，包括荒漠、沙地、砾石地、裸岩、盐碱地等' },
    100: { color: '#C8F0FF', name: '冰川和永久积雪', description: '由永久积雪、冰川和冰盖覆盖的土地，包括高山地区永久积雪、冰川，以及极地冰盖等' },
    255: { color: '#00C8FF', name: '海洋', description: '海洋水域' },
  }
}
